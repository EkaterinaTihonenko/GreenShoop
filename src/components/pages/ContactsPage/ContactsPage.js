      ...
      contacts: [
        {
          ...
          text: 'График работы: Понедельник – Воскресенье с 09:00 до 21:00. <br> Это бесплатные телефоны по которым вы можете продиктовать список товаров, и операторы примут вашу заявку.',
        },
        {
        ...
        },
        {
          ...
          text: 'Предназначена для приема жалоб и рекламаций. Пожалуйста, правильно оформляйте обращения, прикладывайте фото и указывайте номера заказов. <br>Обязательно напишите нам, если у вас есть вопросы по качеству саженцев – наши специалисты помогут разрешить любую проблему.',
        },
        {
          title: 'Почта',
          ...
          text: 'Предназначена для обратной связи с покупателями. Напишите нам, если у вас есть вопросы по продукции, качеству<br>обслуживания, оплате или сроках доставки. Мы обязательно ответим вам в течение 48 часов. <br>ООО «GreenShoop» УНП – 391811175. Юридический адрес: 215965, Республика Беларусь, г. Гомель, ул. Орловская 70. оф. 409.',
        },
      ],
    };
  }
