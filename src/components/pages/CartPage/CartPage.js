    ...
    return `
      <div class="container mt-5">
               ...
               ${this.state.products
                 .map((item) => {
                  ...
                  <tr>
                     ...
                     <td class="text-start ps-0">
                        <button class='btn btn-success delete' data-id="${item.id}">Удалить</button>
                     </td>
         ...
         <tfooter class="d-flex justify-content-end align-items-center p-4 pe-5 me-2 fw-bold fs-6">
            <tr>
               <td>
                  <button type="button" class='btn btn-success delete-items me-2'>Очистить корзину</button>
               </td>
               <td>
                  <button type="button" class='btn btn-success order me-5 ms-2'>Оформить заказ</button>
               </td>
               <td>Итого:</td>
