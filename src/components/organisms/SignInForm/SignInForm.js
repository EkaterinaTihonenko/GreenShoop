    ...
    return `
         <form>
            ...
            <div class="mt-2 d-flex justify-content-between">
               <button type="submit" class="btn bg-success btn-submit text-light">
                  Войти
               </button>
               <button type="button" class="btn bg-success text-light d-flex justify-content-center align-items-center">
